...
#[derive(Debug)]
pub struct RestorePointProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RestorePointProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RestorePoint processing");
    
    let mut processor = RestorePointProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RestorePointProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RestorePointProcessor::new(false);
